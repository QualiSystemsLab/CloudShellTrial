...
class Jmeter(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'Jmeter'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype Jmeter
        """
        result = Jmeter(name=context.resource.name)
    ...
    def tests_location(self):
        ...
        :rtype: str
        """
        return self.attributes['Jmeter.Tests Location'] if 'Jmeter.Tests Location' in self.attributes else None

    @tests_location.setter
    def tests_location(self, value):
        """
        Location of JMeter test files (Base URL)
        :type value: str
        """
        self.attributes['Jmeter.Tests Location'] = value
    ...
    def rdp_port(self):
        ...
        :rtype: str
        """
        return self.attributes['Jmeter.RDP_Port'] if 'Jmeter.RDP_Port' in self.attributes else None

    @rdp_port.setter
    def rdp_port(self, value='3389'):
        """
        Port for RDP Connection via QualiX
        :type value: str
        """
        self.attributes['Jmeter.RDP_Port'] = value
    ...
    def ssh_port(self):
        ...
        :rtype: str
        """
        return self.attributes['Jmeter.SSH_Port'] if 'Jmeter.SSH_Port' in self.attributes else None
    ...
    def ssh_port(self, value='22'):
        ...
        :type value: str
        """
        self.attributes['Jmeter.SSH_Port'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['Jmeter.User'] if 'Jmeter.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['Jmeter.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['Jmeter.Password'] if 'Jmeter.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['Jmeter.Password'] = value
    ...
    def public_ip(self):
        ...
        :rtype: str
        """
        return self.attributes['Jmeter.Public IP'] if 'Jmeter.Public IP' in self.attributes else None
    ...
    def public_ip(self, value):
        ...
        :type value: str
        """
        self.attributes['Jmeter.Public IP'] = value
