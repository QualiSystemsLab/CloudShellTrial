...
class SeleniumHub(object):
    def __init__(self, name):
        ...
        self.attributes = {}
        self.resources = {}
        self._cloudshell_model_name = 'SeleniumHub'
        self._name = name
    ...
    def create_from_context(cls, context):
        ...
        :rtype SeleniumHub
        """
        result = SeleniumHub(name=context.resource.name)
    ...
    def tests_location(self):
        ...
        :rtype: str
        """
        return self.attributes['SeleniumHub.Tests Location'] if 'SeleniumHub.Tests Location' in self.attributes else None

    @tests_location.setter
    def tests_location(self, value):
        """
        Location of Selenium test files (Base URL)
        :type value: str
        """
        self.attributes['SeleniumHub.Tests Location'] = value
    ...
    def www_port(self):
        ...
        :rtype: str
        """
        return self.attributes['SeleniumHub.WWW_Port'] if 'SeleniumHub.WWW_Port' in self.attributes else None

    @www_port.setter
    def www_port(self, value='80'):
        """
        Port for Web connectivity
        :type value: str
        """
        self.attributes['SeleniumHub.WWW_Port'] = value
    ...
    def ssh_port(self):
        ...
        :rtype: str
        """
        return self.attributes['SeleniumHub.SSH_Port'] if 'SeleniumHub.SSH_Port' in self.attributes else None

    @ssh_port.setter
    def ssh_port(self, value='22'):
        """
        Port for SSH Connection via QualiX
        :type value: str
        """
        self.attributes['SeleniumHub.SSH_Port'] = value
    ...
    def user(self):
        ...
        :rtype: str
        """
        return self.attributes['SeleniumHub.User'] if 'SeleniumHub.User' in self.attributes else None
    ...
    def user(self, value):
        ...
        :type value: str
        """
        self.attributes['SeleniumHub.User'] = value
    ...
    def password(self):
        ...
        :rtype: string
        """
        return self.attributes['SeleniumHub.Password'] if 'SeleniumHub.Password' in self.attributes else None
    ...
    def password(self, value):
        ...
        :type value: string
        """
        self.attributes['SeleniumHub.Password'] = value
    ...
    def public_ip(self):
        ...
        :rtype: str
        """
        return self.attributes['SeleniumHub.Public IP'] if 'SeleniumHub.Public IP' in self.attributes else None
    ...
    def public_ip(self, value):
        ...
        :type value: str
        """
        self.attributes['SeleniumHub.Public IP'] = value
