...
create_res_result = api.CreateResource("CloudShell Trial", "CloudShell Independent Trial", "CS Ind Trial {0}".format(domain_name), "NA", "CloudShell Trials", resourceDescription="Trial resource for {0} {1}".format(first_name, last_name))
